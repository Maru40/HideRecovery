/*!
@file Stator_BigShootSlime.cpp
@brief Stator_BigShootSlimeのクラス実体
担当：丸山裕喜
*/
	...
	namespace Enemy {
		...
		namespace BigShootSlime {
			...
			struct Stator::Parametor
			{
				...
				std::shared_ptr<ShootSlime::StateNode::Attack_Parametor> attackParamPtr;  //攻撃
				...
				Parametor() :
					...
					attackParamPtr(new ShootSlime::StateNode::Attack_Parametor()),
			...
			void Stator::CreateNode() {
				...
				//攻撃
				m_stateMachine->AddNode(State::Attack, std::make_shared<ShootSlime::StateNode::Attack>(enemy, m_paramPtr->attackParamPtr));  //新規作成
