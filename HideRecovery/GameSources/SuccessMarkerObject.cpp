/*!
@file SuccessMarkerObject.cpp
@brief SuccessMarkerObjectのクラス実体
担当：丸山裕喜
*/
...
namespace basecross {
	...
	SuccessMarkerObject::SuccessMarkerObject(const std::shared_ptr<Stage>& stage)
		:BoardObject(stage,
	...
	void SuccessMarkerObject::OnCreate() {
