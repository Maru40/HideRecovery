...
/*!
@file Animator_ShootSlime.cpp
@brief Animator_ShootSlimeのクラス実体
担当：丸山裕喜
*/
...
#include "SubAnimator_Walk_ShootSlime.h"
	...
	namespace Enemy {
		...
		namespace ShootSlime {
			...
			void Animator::CreateNode() {
				...
				//移動
				m_stateMachine->AddNode(StateType::Walk, std::make_shared<Enemy::ShootSlime::SubAnimator::Walk>(GetGameObject()));
