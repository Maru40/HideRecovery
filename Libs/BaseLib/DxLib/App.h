...
*/
	...
	class App {
		...
		std::shared_ptr<itbs::Input::InputDevice> m_inputDevice;
	...
	public:
		...
		*/
		...
		{
			m_inputDevice->OnKeyDown(vk_keycode);
		}

		void OnKeyUp(const UINT8 vk_keycode)
		{
			m_inputDevice->OnKeyUp(vk_keycode);
		}

		const std::shared_ptr<itbs::Input::InputDevice>& GetMyInputDevice() const
		{
