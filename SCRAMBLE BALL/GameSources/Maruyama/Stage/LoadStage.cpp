...
#include"Patch/GameSaveManager.h"
...
namespace basecross
{
	...
	const std::vector<LoadStage::ResourceLoadData> LoadStage::m_texureResourceLoadDatas =
	{
		...
		ResourceLoadData(L"Process_TX",L"Process_TX.png"),
		...
		// デフォルトテクスチャ
		ResourceLoadData(L"Default_TX", L"Default_TX.png"),
		...
		ResourceLoadData(L"GradientNoise_TX", L"GradientNoise_TX.png"),
		ResourceLoadData(L"Aura_TX", L"Aura_TX.png"),
		ResourceLoadData(L"Aura2_TX", L"Aura2_TX.png"),
		...
		ResourceLoadData(L"Arrow_Detph_TX", L"Arrow_Depth.png"),
